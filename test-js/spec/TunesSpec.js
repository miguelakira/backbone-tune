...
describe("Album", function () {
    ...
    // usually describes a method or use case for that class
    ...
    describe("first track", function() {
        it("identifies correct first track", function() {
            expect(this.album.isFirstTrack(0)).toBeTruthy(); //method receives a index number
        });
    });
